"""
Analytics-enabled export for HS_GM_Ctrl_multiomics_UCSC_final.h5ad.
...
OUTPUT_PATH = ROOT / "hs_gm_ctrl_multiomics_analytics.html"
...
export_to_html(
    ...
    title="HS GM Ctrl Multiomics Analytics",
    theme="light",
    spot_size=3.5,
